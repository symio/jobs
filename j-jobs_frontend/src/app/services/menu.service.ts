...
export class MenuService {
    icons: { [key: string]: string } = {
        accueil:
            ...
            '       <g>' +
            '           <path d="M362.667,383.841v128H448c35.346,0,64-28.654,64-64V253.26c0.005-11.083-4.302-21.733-12.011-29.696l-181.29-195.99 c-31.988-34.61-85.976-36.735-120.586-4.747c-1.644,1.52-3.228,3.103-4.747,4.747L12.395,223.5 C4.453,231.496-0.003,242.31,0,253.58v194.261c0,35.346,28.654,64,64,64h85.333v-128c0.399-58.172,47.366-105.676,104.073-107.044C312.01,275.383,362.22,323.696,362.667,383.841z"></path>' +
            '           <path d="M256,319.841c-35.346,0-64,28.654-64,64v128h128v-128C320,348.495,291.346,319.841,256,319.841z"></path>' +
            '       </g>' +
            '   </g>' +
            '</svg>',
        ajoutemploi:
            '<svg class="iconeDesktop ajoutEmploi" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" data-name="Layer 1">' +
            ...
            '</svg>',
        dashboard:
            '<svg class="iconeDesktop house" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" fill="currentColor">' +
            '   <g>' +
            '       <path d="M256,319.841c-35.346,0-64,28.654-64,64v128h128v-128C320,348.495,291.346,319.841,256,319.841z"></path>' +
            '       <g>' +
            ...
            '</svg>',
        profil:
            '<svg viewBox="0 -5 24 24" fill="currentColor">' +
            '    <path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2" />' +
            '    <circle cx="12" cy="7" r="4" />' +
            '</svg>',
        statistiques:
            '<svg class="iconeDesktop histo" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" data-name="Layer 1">'+
    ...
    getUserMenuData(username: string): UserMenuData {
        return {
            title: username,
            items: [
                { label: 'Accueil', link: '/', icon: 'accueil' },
                { label: 'Mon Profil', link: '/profil', icon: 'profil' },
            ]
        };
    }
