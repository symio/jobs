...
public class OAuth2Service {
    ...
    public Optional<OAuth2TokenResponse> generateClientCredentialsToken(String email, String clientSecret, String requestedScopes, String clientSignature) {
        ...
        if (
            ...
            if(
                !jwtService.isClientCredentialsTokenValid(clientSecret, email) ||
                user == null ||
        ...
        final String authToken = jwtService.generateClientCredentialsToken(claimsAuth, email, 24);
        ...
        return Optional.of(new OAuth2TokenResponse(authToken, rememberMeToken, "Bearer", 24 * 60 * 60, scope));
    }
